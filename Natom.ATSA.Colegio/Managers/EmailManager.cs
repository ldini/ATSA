...
namespace Natom.ATSA.Colegio.Managers
{
    public static class EmailManager
    {
        ...
        {
            var fromAddress = new MailAddress(ConfigurationManager.AppSettings["ATSA.Email.Emisor"], "ATSA - Sistema de colegio ONLINE");
            ...
            string body = String.Format("<h2>ATSA - Sistema de colegio ONLINE</h2><br/><br/>Por favor, para <b>generar la clave de acceso al sistema</b> haga clic en el siguiente link: {0}", link);
